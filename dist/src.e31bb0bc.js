...
var model = [new _block.TitleBlock('Конструктор сайтов на чистом JavaScript', {
  tag: 'h2',
  styles: {
...
}), new _block.ColumnsBlock(['Приложение на чистом JavaScript, без использования библиотек', 'Узнаешь как работает принципы SOLID и ООП в JavaScript за один курс', 'JavaScript - это просто, интересно. Научись создавать любые UI своими руками'], {
  styles: {
...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    value: function add(evt) {
      ...
      var value = evt.target.value.value;
      var styles = evt.target.styles.value;
